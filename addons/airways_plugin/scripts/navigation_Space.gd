...
## @experimental
##[b]WIP Does not work currently[/b] [br]The physics layer of the node scans the environment, allowing for the exclusion of specific objects that are not considered 'terrain' This feature ensures that the node avoids collisions with non-essential elements such as props within the level
...
#--------------------------------------------------------------#
@export var point_dict: Dictionary = {} ##the dictionary that will hold all of the points position along with their ids.[br][b]Do not fucking thouch this i'm already holding this whole plugin by glue and hope[/b]
